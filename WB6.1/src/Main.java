public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(students[0] + "you will sit at " + (seat += 1));
        System.out.println(students[1] + "you will sit at " + (seat += 1) );
        System.out.println(students[2] + "you will sit at " + (seat += 1) );
        System.out.println(students[3] + "you will sit at " + seat + 1 );
        System.out.println(students[4] + "you will sit at " + seat + 1 );
